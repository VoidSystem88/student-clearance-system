    ...
    */
    ...
    Route::prefix('admin')->name('admin.')->middleware(['auth', 'check.maintenance'])->group(function () {
        ...
        Route::put('/departments/{id}/assign-years', [AdminController::class, 'assignYearsToDepartment'])->name('department.assign-years');
    ...
    Route::prefix('staff')->name('staff.')->middleware(['auth', 'check.maintenance'])->group(function () {
        ...
        // Old requirements (keep for compatibility)
    ...
    Route::get('/student/clearance/view-slip', [ClearanceRequestController::class, 'viewSlip'])->name('student.clearance.view');
        ...
        // ============ BAGONG MGA CONTROLLER ROUTES (ADMIN) ============
    // Student Management (bagong controller)
    Route::get('/students', [App\Http\Controllers\Admin\StudentManagementController::class, 'index'])->name('students');
    Route::post('/students', [App\Http\Controllers\Admin\StudentManagementController::class, 'store'])->name('student.store');
    Route::get('/students/{id}/edit-data', [App\Http\Controllers\Admin\StudentManagementController::class, 'getData'])->name('student.edit-data');
