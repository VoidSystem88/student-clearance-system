...
@section('header', 'Student Feedbacks')
                ...
                <tr class="hover:bg-gray-50 transition">
                    ...
                    <td class="px-5 py-3">
                        <button onclick="viewFeedback(this)" 
                                data-id="{{ $fb->id }}"
                                data-message="{{ addslashes($fb->message) }}"
                                data-student="{{ addslashes(($fb->user->first_name ?? '') . ' ' . ($fb->user->last_name ?? '')) }}"
                                data-student-id="{{ addslashes($fb->user->student_id ?? '') }}"
                                data-rating="{{ $fb->rating }}"
                                data-category="{{ $fb->category }}"
                                data-status="{{ $fb->status }}"
                                data-response="{{ addslashes($fb->admin_response) }}"
