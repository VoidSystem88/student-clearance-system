...
<head>
    ...
    <title>Login - Clearance System | TCC</title>
        ...
        <div class="flex-1 flex items-center justify-center px-4 py-12">
            <div class="bg-white/10 backdrop-blur-md rounded-2xl shadow-2xl p-8 w-full max-w-md card-hover border border-white/20">
                <div class="text-center mb-8">
                    ...
                    <p class="text-white/70 text-sm mt-1">Login to your account</p>
                </div>
                ...
                <form method="POST" action="{{ route('login.post') }}">
                    ...
                    <div class="mb-5">
                        <label class="block text-white/80 text-sm font-medium mb-2">
                            <i class="fas fa-envelope mr-2"></i> Email or Student ID
                        </label>
                        <div class="relative">
                            <i class="fas fa-user absolute left-3 top-3 text-white/50"></i>
                            <input type="text" name="username" 
                                   class="w-full pl-10 pr-3 py-2 bg-white/20 border border-white/30 rounded-lg text-white placeholder-white/50 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent" 
                                   placeholder="email@tcc.com or 2023-00001" required>
                        </div>
                        <p class="text-white/50 text-xs mt-1">Use your email or Student ID to login</p>
                    </div>
                ...
                <div class="mt-6 text-center">
                    <a href="{{ route('password.forgot') }}" class="text-white/70 hover:text-white text-sm transition">
                        <i class="fas fa-key mr-1"></i> Forgot Password?
                    </a>
                </div>

                <div class="mt-6 pt-6 border-t border-white/20 text-center">
                    <p class="text-white/60 text-sm">Don't have an account?</p>
                    <a href="{{ route('student.register') }}" class="text-blue-400 hover:text-blue-300 text-sm font-medium transition">
