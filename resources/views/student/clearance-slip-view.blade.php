...
<div class="print-btn-container no-print">
    ...
    <a href="{{ route('student.clearance') }}" style="margin-left: 10px; background: #6b7280; color: white; text-decoration: none; padding: 10px 20px; border-radius: 8px; font-family: Arial, sans-serif; font-size: 14px;">
        ← Back
    </a>
</div>
...
<div class="content">
    ...
    <div class="qr-code">
        ...
        <p style="font-size: 9px; word-break: break-all;">Verification URL: {{ $verifyUrl ?? 'N/A' }}</p>
    </div>
    @endif
