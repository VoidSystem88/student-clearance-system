    ...
    <div class="bg-green-50 rounded-xl p-3 border border-green-100">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-xl font-bold text-green-700">{{ $approvedCount ?? 0 }}</p>
            </div>
    ...
    <div class="bg-yellow-50 rounded-xl p-3 border border-yellow-100">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-xl font-bold text-yellow-700">{{ $pendingCount ?? 0 }}</p>
            </div>
    ...
    <div class="bg-red-50 rounded-xl p-3 border border-red-100">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-xl font-bold text-red-700">{{ $rejectedCount ?? 0 }}</p>
            </div>
    ...
    <div class="bg-gray-50 rounded-xl p-3 border border-gray-100">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-xl font-bold text-gray-700">{{ $notSubmittedCount ?? 0 }}</p>
            </div>
...
<div class="bg-white rounded-xl p-4 shadow-sm border border-gray-100 mb-6">
    ...
    <div class="mt-4 grid grid-cols-2 gap-3">
        <a href="{{ route('student.clearance.view-pdf') }}" target="_blank" 
        ...
        <a href="{{ route('student.clearance.print') }}" 
...
<div class="space-y-3">
    @forelse($departments ?? [] as $department)
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
            <!-- Card Header -->
            <div class="px-4 py-3 border-b border-gray-100 {{ $status == 'approved' ? 'bg-green-50' : ($status == 'rejected' ? 'bg-red-50' : ($status == 'pending' ? 'bg-yellow-50' : 'bg-gray-50')) }}">
                <div class="flex justify-between items-start">
                    <div class="flex-1">
                        <h4 class="font-semibold text-gray-800 text-sm">{{ $department->name }}</h4>
                        @if($department->handler_name)
                            <div class="text-xs text-gray-500 mt-0.5">{{ $department->handler_name }}</div>
                        @endif
                    </div>
                    <div class="ml-2">
                        @if($status == 'approved')
            ...
            <div class="px-4 py-3 space-y-3">
                ...
                <div class="flex justify-between items-center text-xs">
                    ...
                    <span class="text-gray-700">{{ $request ? $request->submitted_at->format('M d, Y') : '—' }}</span>
                </div>
