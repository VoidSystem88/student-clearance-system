<?php $__env->startSection('title', 'Backup Access'); ?>
<?php $__env->startSection('header', 'Backup Access'); ?>
...
<div class="min-h-[80vh] flex items-center justify-center">
    <div class="bg-white rounded-lg shadow-xl p-8 w-full max-w-md">
        ...
        <form method="POST" action="<?php echo e(route('admin.backup.verify')); ?>">
            <?php echo csrf_field(); ?>
            <div class="mb-4">
        ...
        <div class="mt-4 text-center">
            <a href="<?php echo e(route('admin.dashboard')); ?>" class="text-gray-500 hover:text-gray-700 text-sm">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/vol15_6/infinityfree.com/if0_42013478/voidclearancesystem.gt.tc/htdocs/resources/views/admin/backup-password.blade.php ENDPATH**/ ?>