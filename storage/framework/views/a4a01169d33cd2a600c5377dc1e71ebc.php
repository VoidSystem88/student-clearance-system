    ...
    <div class="profile-header">
        ...
        <div class="profile-pic-container" onclick="window.openModalFunc()" title="Click to change profile picture">
            <img id="profilePagePic" class="profile-pic"
                 src="<?php echo e(Auth::user()->profile_photo_url ?? 'https://ui-avatars.com/api/?background=3b82f6&color=fff&name=' . urlencode(Auth::user()->first_name ?? 'User') . '&size=120'); ?>"
                 alt="Profile Picture">
        ...
        <!-- Student Name & Info -->
        <h2 class="profile-name"><?php echo e($student->first_name ?? ''); ?> <?php echo e($student->last_name ?? ''); ?></h2>
        <p class="profile-role"><?php echo e($student->course ?? 'N/A'); ?> - <?php echo e($student->year_level ?? 'N/A'); ?></p>
        
        <p class="text-xs text-gray-400 dark:text-gray-500 mt-2">
            <i class="fas fa-id-card mr-1"></i> Student ID: <?php echo e($student->student_id ?? 'N/A'); ?> &nbsp;|&nbsp; 
            <i class="fas fa-envelope mr-1"></i> <?php echo e($student->email ?? 'N/A'); ?>

        </p>
        
        <p class="text-xs text-gray-400 dark:text-gray-500 mt-1">
            <i class="fas fa-calendar-alt mr-1"></i> Member since <?php echo e($student->created_at ? $student->created_at->format('F d, Y') : 'N/A'); ?>
            ...
            <form method="POST" action="<?php echo e(route('student.profile.update')); ?>">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input type="text" value="<?php echo e($student->student_id ?? 'N/A'); ?>" 
                    ...
                    <div>
                        ...
                        <input type="text" value="<?php echo e($student->account_id ?? 'N/A'); ?>" 
                               class="w-full bg-gray-100 dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-lg px-3 py-2 text-sm text-gray-500 dark:text-gray-400 cursor-not-allowed" 
                               readonly disabled>
                    </div>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="text" value="<?php echo e($student->course ?? 'N/A'); ?>" 
                               class="w-full bg-gray-100 dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-lg px-3 py-2 text-sm text-gray-500 dark:text-gray-400 cursor-not-allowed" 
                               readonly disabled>
                    ...
                    <div>
                        ...
                        <input type="text" value="<?php echo e($student->year_level ?? 'N/A'); ?>" 
                               class="w-full bg-gray-100 dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-lg px-3 py-2 text-sm text-gray-500 dark:text-gray-400 cursor-not-allowed" 
                               readonly disabled>
