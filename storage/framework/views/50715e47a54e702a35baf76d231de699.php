...
<body class="font-sans antialiased">
        ...
        <div class="verification-card max-w-md w-full">
            ...
            <div class="bg-gray-800/50 backdrop-blur-sm rounded-2xl shadow-2xl border border-gray-700">
                <div class="p-8">
                    ...
                    <form method="POST" action="<?php echo e(route('support.2fa.verify')); ?>" class="space-y-4">
                        <?php echo csrf_field(); ?>
                        <div>
    ...
    <script>
        ...
        document.getElementById('resendBtn')?.addEventListener('click', async function() {
            ...
            try {
                const response = await fetch('<?php echo e(route("support.2fa.resend")); ?>', {
                    method: 'POST',
                    headers: {
...
</html><?php /**PATH /home/vol15_6/infinityfree.com/if0_42013478/voidclearancesystem.gt.tc/htdocs/resources/views/support/2fa-verify.blade.php ENDPATH**/ ?>