...
<div class="container mx-auto">
        ...
        <table class="w-full">
            ...
            <tbody>
                ...
                <tr class="border-b hover:bg-gray-50">
                    <td class="p-3"><?php echo e($dept->id); ?></td>
                    
                    <!-- Department Column -->
                    <td class="p-3">
                        <div class="font-semibold text-gray-800"><?php echo e($dept->name); ?></div>
                    </td>
                    
                    <!-- Handler Column -->
                    <td class="p-3">
                        <?php if($dept->handler_name): ?>
                            <div class="text-sm font-medium text-gray-800"><?php echo e($dept->handler_name); ?></div>
                        <?php else: ?>
                    ...
                    <!-- Staff Email Column -->
                    <td class="p-3 text-gray-600"><?php echo e($dept->staff_email ?? '-'); ?></td>
                        ...
                        <?php if(count($assignedYears) > 0): ?>
                            <div class="flex flex-wrap gap-1 mb-2">
                                <?php $__currentLoopData = $assignedYears; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $year): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    ?>
                                    <span class="inline-flex items-center gap-1 px-2 py-1 rounded text-xs font-medium <?php echo e($yearColor); ?>">
                                        <i class="fas <?php echo e($yearIcon); ?> text-xs"></i>
                                        <?php echo e($year); ?>

                                    </span>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </div>
                            <button onclick="openYearModal(<?php echo e($dept->id); ?>, '<?php echo e(addslashes($dept->name)); ?>', <?php echo e(json_encode($assignedYears)); ?>)" 
    ...
    <button onclick="openYearModal(<?php echo e($dept->id); ?>, '<?php echo e(addslashes($dept->name)); ?>', [])" 
            class="inline-flex items-center gap-1 text-xs text-blue-600 hover:text-blue-800 transition ml-2">
...
<?php endif; ?>
                    ...
                    <td class="p-3">
                        <div class="flex gap-1">
                            <button onclick="openEditModal(<?php echo e($dept->id); ?>)" class="inline-flex items-center gap-1 bg-yellow-500 text-white px-3 py-1 rounded text-sm hover:bg-yellow-600 transition">
                                <i class="fas fa-edit"></i> Edit
                            </button>
                            <button onclick="confirmDeleteDept(<?php echo e($dept->id); ?>, '<?php echo e(addslashes($dept->name)); ?>')" 
                                    class="inline-flex items-center gap-1 bg-red-600 text-white px-3 py-1 rounded text-sm hover:bg-red-700 transition">
                                <i class="fas fa-trash"></i> Delete
                            </button>
                        </div>
                        <form id="delete-dept-form-<?php echo e($dept->id); ?>" method="POST" action="<?php echo e(route('admin.department.destroy', $dept->id)); ?>" class="hidden">
                            <?php echo csrf_field(); ?>
...
<script>
    ...
    function openAddModal() {
        ...
        document.getElementById('deptForm').action = '<?php echo e(route("admin.department.store")); ?>';
    ...
    // ✅ REMOVE any query params, direct URL lang
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/vol15_6/infinityfree.com/if0_42013478/voidclearancesystem.gt.tc/htdocs/resources/views/admin/departments.blade.php ENDPATH**/ ?>