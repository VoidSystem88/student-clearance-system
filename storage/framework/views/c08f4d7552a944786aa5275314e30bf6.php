    ...
    <div id="feedbacksContainer" class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden transition-colors duration-300">
        ...
        <div id="feedbacksList" class="divide-y divide-gray-100 dark:divide-gray-700 max-h-[600px] overflow-y-auto">
            ...
            <div class="feedback-item p-4 hover:bg-gray-50 dark:hover:bg-gray-700/50 transition" data-id="<?php echo e($fb->id); ?>">
                <div class="flex justify-between items-start mb-2">
                    <div class="flex items-center gap-2 flex-wrap">
                        ...
                        <span class="text-xs px-2 py-0.5 rounded-full flex items-center gap-1
                            ...
                            <?php if($fb->category == 'bug'): ?><i class="fas fa-bug text-xs"></i>
                            <?php elseif($fb->category == 'feature'): ?><i class="fas fa-lightbulb text-xs"></i>
                            <?php elseif($fb->category == 'improvement'): ?><i class="fas fa-chart-line text-xs"></i>
                            <?php elseif($fb->category == 'experience'): ?><i class="fas fa-smile-wink text-xs"></i>
                            <?php else: ?><i class="fas fa-comment-dots text-xs"></i><?php endif; ?>
                ...
                <p class="text-sm text-gray-600 dark:text-gray-400 mt-2 feedback-message"><?php echo e($fb->message); ?></p>
                ...
                <div class="feedback-actions">
                    <button onclick="editFeedback(<?php echo e($fb->id); ?>, '<?php echo e(addslashes($fb->message)); ?>', <?php echo e($fb->rating); ?>, '<?php echo e($fb->category); ?>')" 
                        class="feedback-edit-btn">
                        <i class="fas fa-edit"></i> Edit
                    </button>
                    <button onclick="deleteFeedback(<?php echo e($fb->id); ?>)" 
...
<script>
    ...
    let currentRating = <?php echo e(old('rating', 0)); ?>;
    let currentCategory = '<?php echo e(old('category', '')); ?>';
    let editingId = null;
