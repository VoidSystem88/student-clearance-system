...
<head>
    ...
    <title>Support - <?php echo $__env->yieldContent('title'); ?></title>
...
<body class="bg-gray-50 font-sans antialiased">
    ...
    <aside id="sidebar" class="sidebar fixed top-0 left-0 h-full w-64 bg-white shadow-xl z-40 flex flex-col sidebar-transition">
        ...
        <nav class="flex-1 py-4 overflow-y-auto">
            <a href="<?php echo e(route('support.dashboard')); ?>" class="flex items-center gap-3 px-5 py-3 text-gray-700 hover:bg-gray-100 transition <?php echo e(request()->routeIs('support.dashboard') ? 'nav-active' : ''); ?>">
                <i class="fas fa-tachometer-alt w-5"></i>
                <span>Dashboard</span>
            </a>
            
            <!-- Requests Link with Badge -->
            <a href="<?php echo e(route('support.requests')); ?>" id="requestsLink" class="flex items-center gap-3 px-5 py-3 text-gray-700 hover:bg-gray-100 transition <?php echo e(request()->routeIs('support.requests') ? 'nav-active' : ''); ?>">
            ...
            <a href="<?php echo e(route('support.feedbacks')); ?>" id="feedbacksLink" class="flex items-center gap-3 px-5 py-3 text-gray-700 hover:bg-gray-100 transition <?php echo e(request()->routeIs('support.feedbacks') ? 'nav-active' : ''); ?>">
                <i class="fas fa-star w-5"></i>
                <span>Feedbacks</span>
                <span id="feedbacksBadge" class="nav-badge zero ml-auto" style="display: none;">0</span>
            </a>
                                        
            <a href="<?php echo e(route('support.students')); ?>" class="flex items-center gap-3 px-5 py-3 text-gray-700 hover:bg-gray-100 transition <?php echo e(request()->routeIs('support.students') ? 'nav-active' : ''); ?>">
                <i class="fas fa-users w-5"></i>
                <span>Manage Students</span>
            </a>
                                        
            <a href="<?php echo e(route('support.profile')); ?>" class="flex items-center gap-3 px-5 py-3 text-gray-700 hover:bg-gray-100 transition <?php echo e(request()->routeIs('support.profile') ? 'nav-active' : ''); ?>">
                <i class="fas fa-user-circle w-5"></i>
                <span>My Profile</span>
                <?php if(auth()->user()->admin_2fa_enabled): ?>
                    <span class="ml-auto text-xs bg-green-100 text-green-700 px-1.5 py-0.5 rounded-full">2FA ON</span>
                <?php endif; ?>
            </a>
            <a href="<?php echo e(route('support.announcements')); ?>" class="flex items-center gap-3 px-5 py-3 text-gray-700 hover:bg-gray-100 transition <?php echo e(request()->routeIs('support.announcements') ? 'nav-active' : ''); ?>">
            ...
            <a href="<?php echo e(route('support.reminders')); ?>" class="flex items-center gap-3 px-5 py-3 text-gray-700 hover:bg-gray-100 transition <?php echo e(request()->routeIs('support.reminders') ? 'nav-active' : ''); ?>">
                ...
                <?php
                    $activeRemindersCount = \App\Models\Reminder::where('is_active', true)
                        ...
                        ->count();
                ?>
                <?php if($activeRemindersCount > 0): ?>
                    <span class="ml-auto text-xs bg-red-100 text-red-700 px-1.5 py-0.5 rounded-full"><?php echo e($activeRemindersCount); ?></span>
                <?php endif; ?>
            </a>
            <!-- MAINTENANCE MENU ITEM -->
            <a href="<?php echo e(route('support.maintenance')); ?>" class="flex items-center gap-3 px-5 py-3 text-gray-700 hover:bg-gray-100 transition <?php echo e(request()->routeIs('support.maintenance') ? 'nav-active' : ''); ?>">
                <i class="fas fa-tools w-5"></i>
                <span>Maintenance</span>
                <?php if(Cache::get('maintenance_mode') || Cache::get('read_only_mode')): ?>
                    <span class="ml-auto">
        ...
        <div class="bg-white shadow-sm sticky top-0 z-20">
            <div class="px-4 py-3 flex justify-between items-center">
                <div class="flex items-center gap-3">
                    ...
                    <h2 class="text-lg font-semibold text-gray-700"><?php echo $__env->yieldContent('header'); ?></h2>
                </div>
                <div class="flex items-center gap-4">
                    ...
                    <div class="relative">
                        ...
                        <div id="supportNotificationDropdown" class="absolute right-0 mt-2 bg-white rounded-lg shadow-xl border border-gray-200 hidden z-50 overflow-hidden">
                            ...
                            <div class="p-2 border-t border-gray-200 text-center bg-gray-50">
                                <a href="<?php echo e(route('support.notifications')); ?>" class="text-sm text-blue-600 hover:text-blue-800 transition font-medium">
                    ...
                    <span class="text-sm text-gray-600 hidden sm:block"><?php echo e(Auth::user()->email ?? 'support@clearance.com'); ?></span>
        ...
        <div id="globalAnnouncementBanner" class="announcement-banner mx-4 mt-4 p-4 rounded-lg shadow-sm flex justify-between items-start">
            <div class="flex items-start gap-3">
                ...
                <div>
                    ...
                    <p class="text-amber-700 text-sm mt-1"><?php echo e($activeAnnouncement); ?></p>
                    <p class="text-xs text-amber-500 mt-2">Posted by Support Team • <?php echo e(now()->format('F j, Y g:i A')); ?></p>
                </div>
            </div>
    ...
    <script>
        ...
        function loadSupportNotificationCounts() {
            fetch('<?php echo e(route("support.notification.counts")); ?>', {
                method: 'GET',
                headers: {
        ...
        function markAllSupportNotificationsAsRead() {
            ...
            fetch('<?php echo e(route("support.notifications.mark-all-read")); ?>', {
                method: 'POST',
                headers: {
                    'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]')?.content || '<?php echo e(csrf_token()); ?>',
                    'Content-Type': 'application/json',
...
</html><?php /**PATH /home/vol15_6/infinityfree.com/if0_42013478/voidclearancesystem.gt.tc/htdocs/resources/views/layouts/support.blade.php ENDPATH**/ ?>