...
<div class="bg-white rounded-xl shadow-sm p-6">
    <div class="flex items-center gap-4 mb-6 pb-4 border-b">
        ...
        <div>
            <h3 class="text-xl font-bold text-gray-800"><?php echo e(Auth::user()->name); ?></h3>
            ...
            <span class="inline-block px-2 py-1 text-xs rounded-full bg-purple-100 text-purple-700 mt-1">
                <i class="fas fa-crown mr-1"></i> <?php echo e(ucfirst(Auth::user()->role)); ?>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div class="border rounded-xl p-5">
            ...
            <form method="POST" action="<?php echo e(route('support.profile.update')); ?>" class="space-y-4">
                <?php echo csrf_field(); ?>
                ...
                <div>
                    ...
                    <input type="text" value="<?php echo e(ucfirst(Auth::user()->role)); ?>" 
                           class="w-full border border-gray-300 rounded-lg p-2 bg-gray-50" readonly>
                </div>
        ...
        <div class="border rounded-xl p-5">
            ...
            <form method="POST" action="<?php echo e(route('support.password.change')); ?>" class="space-y-4">
                <?php echo csrf_field(); ?>
                <div>
        ...
        <div class="border rounded-xl p-5 md:col-span-2">
                ...
                <div class="flex items-center justify-between flex-wrap gap-3">
                    ...
                    <div>
                        <?php if(Auth::user()->admin_2fa_enabled): ?>
                            ...
                            <form method="POST" action="<?php echo e(route('support.2fa.disable')); ?>" class="inline ml-2">
                                <?php echo csrf_field(); ?>
                        ...
                        <?php else: ?>
                            ...
                            <form method="POST" action="<?php echo e(route('support.2fa.enable')); ?>" class="inline ml-2">
                                <?php echo csrf_field(); ?>
            ...
            <div class="bg-blue-50 rounded-lg p-4">
                <p class="text-sm text-blue-800">
                    ...
                    <br><small>Last code generated: <?php echo e(Auth::user()->admin_2fa_expires_at ? Auth::user()->admin_2fa_expires_at->diffForHumans() : 'Never'); ?></small>
                </p>
            </div>
            <?php endif; ?>
        </div>
...
<?php echo $__env->make('layouts.support', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/vol15_6/infinityfree.com/if0_42013478/voidclearancesystem.gt.tc/htdocs/resources/views/support/profile.blade.php ENDPATH**/ ?>