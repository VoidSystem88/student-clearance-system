<?php $__env->startSection('title', 'My Profile - Admin'); ?>
...
<div class="max-w-4xl mx-auto">
    ...
    <div class="bg-gradient-to-r from-blue-600 to-blue-800 rounded-xl shadow-lg overflow-hidden mb-6">
        <div class="px-6 py-8 flex items-center gap-4">
            ...
            <div>
                <h2 class="text-xl font-bold text-white"><?php echo e(Auth::user()->first_name); ?> <?php echo e(Auth::user()->last_name); ?></h2>
                <p class="text-blue-100 flex items-center gap-2 mt-1">
                    <i class="fas fa-envelope"></i> <?php echo e(Auth::user()->email); ?>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
        ...
        <div class="p-5">
            ...
            <form method="POST" action="<?php echo e(route('admin.profile.update')); ?>" id="profileUpdateForm">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mt-6 pt-4 border-t border-gray-100 flex gap-3">
                    ...
                    <a href="<?php echo e(route('admin.dashboard')); ?>" class="bg-gray-200 text-gray-700 px-5 py-2 rounded-lg text-sm font-medium hover:bg-gray-300 transition-all duration-300 flex items-center gap-2">
...
<script>
    function toggle2FA() {
        ...
        fetch('<?php echo e(route("admin.2fa.toggle")); ?>', {
            method: 'POST',
            headers: {
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/vol15_6/infinityfree.com/if0_42013478/voidclearancesystem.gt.tc/htdocs/resources/views/admin/profile.blade.php ENDPATH**/ ?>