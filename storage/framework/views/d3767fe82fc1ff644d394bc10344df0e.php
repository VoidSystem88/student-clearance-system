    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="feedback-box">
                ...
                <p style="margin-top: 8px;"><?php echo e($feedback->message); ?></p>
                <small>Rating: ⭐<?php echo e($feedback->rating); ?>/5 | Category: <?php echo e(ucfirst($feedback->category)); ?></small>
            </div>
            
            <div class="response-box">
                <strong>💬 Admin Response:</strong><br>
                <p style="margin-top: 8px;"><?php echo e($admin_response); ?></p>
            </div>
            
            <div class="status-<?php echo e($feedback->status == 'reviewed' ? 'approved' : 'rejected'); ?>">
                <strong>Status:</strong> <?php echo e(ucfirst($feedback->status)); ?>
            ...
            <div style="text-align: center;">
                <a href="<?php echo e(url('/student/feedback')); ?>" class="button">View Feedback</a>
            </div>
        </div>
        <div class="footer">
...
</html><?php /**PATH /home/vol15_6/infinityfree.com/if0_42013478/voidclearancesystem.gt.tc/htdocs/resources/views/emails/feedback-response.blade.php ENDPATH**/ ?>