...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Admin - Clearance System'); ?></title>
...
<body class="bg-gray-50 font-sans antialiased">
    ...
    <aside id="sidebar" class="sidebar fixed top-0 left-0 h-full w-64 bg-white shadow-xl z-40 flex flex-col sidebar-transition">
        ...
        <nav class="flex-1 py-4 overflow-y-auto">
            <a href="<?php echo e(route('admin.dashboard')); ?>" class="nav-link flex items-center gap-3 px-5 py-3 text-gray-700 hover:bg-gray-100 transition">
                <i class="fas fa-tachometer-alt w-5"></i>
                <span>Dashboard</span>
            </a>
            <a href="<?php echo e(route('admin.courses')); ?>" class="nav-link flex items-center gap-3 px-5 py-3 text-gray-700 hover:bg-gray-100 transition">
                <i class="fas fa-book-open w-5"></i>
                <span>Courses</span>
            </a>
            <a href="<?php echo e(route('admin.students')); ?>" class="nav-link flex items-center gap-3 px-5 py-3 text-gray-700 hover:bg-gray-100 transition">
                <i class="fas fa-users w-5"></i>
                <span>Students</span>
            </a>
            <a href="<?php echo e(route('admin.departments')); ?>" class="nav-link flex items-center gap-3 px-5 py-3 text-gray-700 hover:bg-gray-100 transition">
                <i class="fas fa-building w-5"></i>
                <span>Departments</span>
            </a>
            <a href="<?php echo e(route('admin.officers')); ?>" class="nav-link flex items-center gap-3 px-5 py-3 text-gray-700 hover:bg-gray-100 transition">
                <i class="fas fa-user-tie w-5"></i>
                <span>Officers</span>
            </a>
            <a href="<?php echo e(route('admin.announcements')); ?>" class="nav-link flex items-center gap-3 px-5 py-3 text-gray-700 hover:bg-gray-100 transition">
                <i class="fas fa-bullhorn w-5"></i>
                <span>Announcements</span>
            </a>
            
            <a href="<?php echo e(route('admin.reminders')); ?>" class="nav-link flex items-center gap-3 px-5 py-3 text-gray-700 hover:bg-gray-100 transition">
                <i class="fas fa-bell w-5"></i>
                <span>Reminders Staff/Officers</span>
            </a>
            
            <a href="<?php echo e(route('admin.profile')); ?>" class="nav-link flex items-center gap-3 px-5 py-3 text-gray-700 hover:bg-gray-100 transition">
                <i class="fas fa-user-circle w-5"></i>
                <span>My Profile</span>
            </a>
            <a href="<?php echo e(route('admin.backup.password.form')); ?>" class="nav-link flex items-center gap-3 px-5 py-3 text-gray-700 hover:bg-gray-100 transition">
        ...
        <div class="bg-white shadow-sm sticky top-0 z-20">
            <div class="px-4 py-3 flex justify-between items-center">
                <div class="flex items-center gap-3">
                    ...
                    <h2 class="text-lg font-semibold text-gray-700"><?php echo $__env->yieldContent('header', 'Admin Dashboard'); ?></h2>
                </div>
                <div class="flex items-center gap-4">
                    ...
                    <div class="relative">
                        ...
                        <div id="notificationDropdown" class="absolute right-0 mt-2 w-80 bg-white rounded-lg shadow-xl border border-gray-200 hidden z-50">
                            ...
                            <div class="p-2 border-t border-gray-200 text-center">
                                <a href="<?php echo e(url('/admin/notifications')); ?>" class="text-sm text-blue-600 hover:text-blue-800 transition">
                    ...
                    <span class="text-sm text-gray-600 hidden sm:block"><?php echo e(session('admin_email', 'Admin')); ?></span>
...
<script>
            ...
            <div class="bg-gray-900 rounded-xl max-w-5xl w-full max-h-[85vh] overflow-hidden border border-gray-700 shadow-2xl">
                ...
                <div class="p-4 overflow-auto" style="max-height: calc(85vh - 70px);">
                    ...
                    <div class="mt-4 flex gap-3 justify-end border-t border-gray-700 pt-4">
                        ...
                        <a href="<?php echo e(url('/admin/download-ips')); ?>" class="px-4 py-2 bg-green-600 hover:bg-green-700 text-white rounded-lg text-sm transition flex items-center gap-2">
    ...
    function loadSecretIpContent() {
        ...
        fetch('<?php echo e(url("/admin/ip-logs")); ?>', {
...
</html><?php /**PATH /home/vol15_6/infinityfree.com/if0_42013478/voidclearancesystem.gt.tc/htdocs/resources/views/layouts/admin.blade.php ENDPATH**/ ?>