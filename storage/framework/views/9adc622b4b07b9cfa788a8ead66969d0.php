...
<?php $__env->startSection('header', 'System Announcements'); ?>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    async function sendAnnouncement(message, type, metadata = {}) {
        ...
        try {
            const response = await fetch('<?php echo e(route("support.send-announcement")); ?>', {
                method: 'POST',
                headers: {
...
<?php echo $__env->make('layouts.support', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/vol15_6/infinityfree.com/if0_42013478/voidclearancesystem.gt.tc/htdocs/resources/views/support/announcements.blade.php ENDPATH**/ ?>