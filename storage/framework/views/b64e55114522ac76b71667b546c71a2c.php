...
<body class="bg-gray-50 font-sans antialiased">
        ...
        <aside id="sidebar" class="sidebar">
            ...
            <div class="sidebar-nav">
                <?php if(auth()->guard()->check()): ?>
                    ...
                    <a href="<?php echo e(route('student.clearance')); ?>" class="nav-link">
                        <i class="fas fa-clipboard-list w-5"></i><span>Clearance</span>
                    </a>
                    <a href="<?php echo e(route('student.reminders')); ?>" class="nav-link">
                        <i class="fas fa-bell w-5"></i><span>Reminders</span>
                    </a>
                    <a href="<?php echo e(route('student.profile')); ?>" class="nav-link">
                        <i class="fas fa-user-circle w-5"></i><span>My Profile</span>
                    </a>
                    <a href="<?php echo e(route('student.feedback')); ?>" class="nav-link">
            ...
            <div class="sidebar-footer">
                ...
                <a href="<?php echo e(route('student.assistance')); ?>" class="nav-link assistance-link">
                ...
                <div class="px-4 py-3 flex justify-between items-center">
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <span class="text-sm hidden sm:block text-gray-600">
                            <?php if(auth()->guard()->check()): ?> <?php echo e(Auth::user()->first_name ?? ''); ?> <?php endif; ?>
                        </span>
                        <img id="profilePicture" class="profile-img cursor-pointer"
                             src="<?php echo e(Auth::user()->profile_photo_url ?? 'https://ui-avatars.com/api/?background=3b82f6&color=fff&name=' . urlencode(Auth::user()->first_name ?? 'User') . '&size=64'); ?>"
                             alt="Profile"
    ...
    <div id="notificationDropdown">
        ...
        <div class="notification-footer">
            <a href="<?php echo e(route('student.reminders')); ?>">View all announcements →</a>
        </div>
    </div>
