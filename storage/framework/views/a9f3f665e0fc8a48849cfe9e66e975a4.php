                            ...
                            <div class="border-b border-gray-200">
                                ...
                                <div class="px-4 py-3 border-b border-gray-100 hover:bg-gray-50 transition">
                                    <div class="flex items-start gap-2">
                                        ...
                                        <div class="flex-1">
                                            <p class="text-sm font-semibold text-gray-800"><?php echo e($reminder->title); ?></p>
                                            <p class="text-xs text-gray-600 mt-1"><?php echo e($reminder->message); ?></p>
                                            <?php if($reminder->end_date): ?>
                                            <p class="text-xs text-gray-400 mt-1">
                                                <i class="fas fa-calendar-alt"></i> Until: <?php echo e($reminder->end_date->format('M d, Y')); ?>
                            ...
                            <div>
                                ...
                                <div class="px-4 py-3 border-b border-gray-100 hover:bg-gray-50 transition">
                                    <div class="flex items-start gap-2">
                                        ...
                                        <div class="flex-1">
                                            <p class="text-sm font-semibold text-gray-800"><?php echo e($announcement->title); ?></p>
                                            <p class="text-xs text-gray-600 mt-1"><?php echo e(Str::limit($announcement->content, 100)); ?></p>
                                            <p class="text-xs text-gray-400 mt-1">
...
</html><?php /**PATH /home/vol15_6/infinityfree.com/if0_42013478/voidclearancesystem.gt.tc/htdocs/resources/views/layouts/staff.blade.php ENDPATH**/ ?>