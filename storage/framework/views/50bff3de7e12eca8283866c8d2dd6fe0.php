...
<div class="no-print print-btn-container">
    ...
    <a href="<?php echo e(route('student.clearance')); ?>" class="back-btn">
        ← Back
    </a>
</div>
...
<div class="clearance-slip">
    <div class="content">
        ...
        <div class="student-info">
            <table>
                <tr>
                    ...
                    <td width="30%"><?php echo e($student->first_name); ?> <?php echo e($student->last_name); ?></td>
                    <td width="20%"><strong>Student ID:</strong></td>
                    <td width="30%"><?php echo e($student->student_id); ?></td>
                </tr>
                <tr>
                    <td><strong>Course:</strong></td>
                    <td><?php echo e($student->course); ?></td>
                    <td><strong>Account ID:</strong></td>
                    <td><?php echo e($student->account_id); ?></td>
                </tr>
                <tr>
                    <td><strong>Email:</strong></td>
                    <td colspan="3"><?php echo e($student->email); ?></td>
                </tr>
            </table>
        </div>
        ...
        <table class="dept-table">
            ...
            <tbody>
                <?php $__currentLoopData = $clearanceRequests; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $request): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    <td><?php echo e($request->department->name); ?></td>
                    <td><?php echo e($request->processed_at ? $request->processed_at->format('F d, Y') : $request->updated_at->format('F d, Y')); ?></td>
                </tr>
        ...
        <div class="qr-code">
            <?php if(isset($qrCodeBase64) && $qrCodeBase64 && !empty($qrCodeBase64)): ?>
                <img src="data:image/png;base64,<?php echo e($qrCodeBase64); ?>" alt="Verification QR Code">
                <p style="font-size: 8pt; margin-top: 5px; color: #555;">Scan to verify authenticity</p>
            <?php else: ?>
                <div class="qr-fallback">
                    <p><strong>Verification Code:</strong></p>
                    <p><?php echo e($student->clearance_token ?? 'N/A'); ?></p>
...
</html><?php /**PATH /home/vol15_6/infinityfree.com/if0_42013478/voidclearancesystem.gt.tc/htdocs/resources/views/student/clearance-slip-view-pdf.blade.php ENDPATH**/ ?>