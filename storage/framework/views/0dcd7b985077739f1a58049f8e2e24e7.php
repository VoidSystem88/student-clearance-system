    ...
    <div class="bg-white rounded-xl shadow-sm">
        ...
        <div class="border-b border-gray-200 px-4 pt-3 flex flex-wrap gap-1 overflow-x-auto">
            ...
            <button class="tab-btn px-4 py-3 text-sm font-medium border-b-2 transition whitespace-nowrap active" 
                ...
                <span class="bg-green-100 text-green-700 px-2 py-0.5 rounded-full text-xs ml-1"><?php echo e($activeReminders->count()); ?></span>
            </button>
            <button class="tab-btn px-4 py-3 text-sm font-medium border-b-2 border-transparent text-gray-500 hover:text-gray-700 transition whitespace-nowrap"
                ...
                <span class="bg-red-100 text-red-700 px-2 py-0.5 rounded-full text-xs ml-1"><?php echo e($inactiveReminders->count()); ?></span>
            </button>
            <button class="tab-btn px-4 py-3 text-sm font-medium border-b-2 border-transparent text-gray-500 hover:text-gray-700 transition whitespace-nowrap"
                    data-tab="all-tab">
                <i class="fas fa-list text-blue-500 mr-1"></i> All
                <span class="bg-blue-100 text-blue-700 px-2 py-0.5 rounded-full text-xs ml-1"><?php echo e($reminders->count()); ?></span>
            </button>
        </div>
        ...
        <div class="p-4">
            ...
            <div id="active-tab" class="tab-content">
                <?php if($activeReminders->count() > 0): ?>
                <div class="overflow-x-auto">
                    <table class="w-full text-sm">
                        ...
                        <tbody class="divide-y divide-gray-100">
                            <?php $__currentLoopData = $activeReminders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $reminder): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="hover:bg-gray-50 transition">
                                <td class="px-4 py-3 text-gray-500"><?php echo e($reminder->id); ?></td>
                                <td class="px-4 py-3 font-semibold text-gray-800"><?php echo e($reminder->title); ?></td>
                                <td class="px-4 py-3 text-gray-600 max-w-[200px] truncate"><?php echo e(Str::limit($reminder->message, 60)); ?></td>
                                <td class="px-4 py-3">
                                    <span class="px-2 py-1 rounded-full text-xs font-medium 
                                        ...
                                        <?php elseif($reminder->target_role == 'student'): ?> bg-green-100 text-green-700
                                        <?php else: ?> bg-gray-100 text-gray-700 <?php endif; ?>">
                                        <?php echo e(ucfirst($reminder->target_role)); ?>

                                    </span>
                                </td>
                                <td class="px-4 py-3 text-gray-600"><?php echo e($reminder->department->name ?? 'All'); ?></td>
                                <td class="px-4 py-3 text-xs text-gray-500">
                                    <?php echo e($reminder->start_date ? $reminder->start_date->format('M d, Y') : 'Now'); ?>

                                    -
                                    <?php echo e($reminder->end_date ? $reminder->end_date->format('M d, Y') : 'No end'); ?>

                                </td>
                                <td class="px-4 py-3">
                                    <button onclick="toggleActive(<?php echo e($reminder->id); ?>)" class="cursor-pointer">
                                ...
                                <td class="px-4 py-3">
                                    <div class="flex gap-1">
                                        <button onclick="openEditModal(<?php echo e($reminder->id); ?>)" class="bg-yellow-500 text-white px-3 py-1.5 rounded-lg text-xs hover:bg-yellow-600 transition">
                                            <i class="fas fa-edit"></i>
                                        </button>
                                        <button onclick="confirmDelete(<?php echo e($reminder->id); ?>, '<?php echo e(addslashes($reminder->title)); ?>')" class="bg-red-600 text-white px-3 py-1.5 rounded-lg text-xs hover:bg-red-700 transition">
            ...
            <div id="inactive-tab" class="tab-content hidden">
                <?php if($inactiveReminders->count() > 0): ?>
                <div class="overflow-x-auto">
                    <table class="w-full text-sm">
                        <thead>
                            <tr class="bg-gray-50 text-left text-xs font-medium text-gray-500 uppercase">
                        ...
                        <tbody class="divide-y divide-gray-100">
                            <?php $__currentLoopData = $inactiveReminders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $reminder): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="hover:bg-gray-50 transition">
                                <td class="px-4 py-3 text-gray-500"><?php echo e($reminder->id); ?></td>
                                <td class="px-4 py-3 font-semibold text-gray-800"><?php echo e($reminder->title); ?></td>
                                <td class="px-4 py-3 text-gray-600 max-w-[200px] truncate"><?php echo e(Str::limit($reminder->message, 60)); ?></td>
