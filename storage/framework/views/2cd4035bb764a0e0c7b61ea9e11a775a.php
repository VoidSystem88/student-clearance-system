    ...
    <div class="bg-white rounded-xl shadow-sm p-5 hover:shadow-md transition">
        <div class="flex justify-between items-start">
            <div>
                ...
                <p class="text-2xl font-bold text-blue-600 mt-1"><?php echo e(($pendingCount ?? 0) + ($approvedCount ?? 0) + ($rejectedCount ?? 0)); ?></p>
            </div>
    ...
    <div class="bg-white rounded-xl shadow-sm p-5 hover:shadow-md transition">
        <div class="flex justify-between items-start">
            <div>
                ...
                <p class="text-2xl font-bold text-yellow-600 mt-1"><?php echo e($pendingCount ?? 0); ?></p>
            </div>
    ...
    <div class="bg-white rounded-xl shadow-sm p-5 hover:shadow-md transition">
        <div class="flex justify-between items-start">
            <div>
                ...
                <p class="text-2xl font-bold text-green-600 mt-1"><?php echo e($approvedCount ?? 0); ?></p>
            </div>
    ...
    <div class="bg-white rounded-xl shadow-sm p-5 hover:shadow-md transition">
        <div class="flex justify-between items-start">
            <div>
                ...
                <p class="text-2xl font-bold text-red-600 mt-1"><?php echo e($rejectedCount ?? 0); ?></p>
            </div>
...
<div class="bg-white rounded-xl shadow-sm">
    ...
    <div class="border-b border-gray-200 px-4 pt-3 flex flex-wrap gap-1 overflow-x-auto">
        <button class="tab-btn px-4 py-3 text-sm font-medium border-b-2 transition whitespace-nowrap active" 
            ...
            <span class="bg-yellow-100 text-yellow-700 px-2 py-0.5 rounded-full text-xs ml-1"><?php echo e($pendingCount ?? 0); ?></span>
        </button>
        <button class="tab-btn px-4 py-3 text-sm font-medium border-b-2 border-transparent text-gray-500 hover:text-gray-700 transition whitespace-nowrap"
            ...
            <span class="bg-green-100 text-green-700 px-2 py-0.5 rounded-full text-xs ml-1"><?php echo e($approvedCount ?? 0); ?></span>
        </button>
        <button class="tab-btn px-4 py-3 text-sm font-medium border-b-2 border-transparent text-gray-500 hover:text-gray-700 transition whitespace-nowrap"
                data-tab="verified-tab">
            <i class="fas fa-clipboard-check text-blue-500 mr-1"></i> Verified by Officer
            <span class="bg-blue-100 text-blue-700 px-2 py-0.5 rounded-full text-xs ml-1"><?php echo e(($verifiedStudents ?? collect([]))->count()); ?></span>
        </button>
        <button class="tab-btn px-4 py-3 text-sm font-medium border-b-2 border-transparent text-gray-500 hover:text-gray-700 transition whitespace-nowrap"
                data-tab="rejected-tab">
            <i class="fas fa-times-circle text-red-500 mr-1"></i> Rejected
            <span class="bg-red-100 text-red-700 px-2 py-0.5 rounded-full text-xs ml-1"><?php echo e($rejectedCount ?? 0); ?></span>
        </button>
    </div>
    ...
    <div class="p-4">
                    ...
                    <table class="w-full text-sm">
                        ...
                        <tbody class="divide-y divide-gray-100">
                            ...
                            <tr class="hover:bg-gray-50 transition">
                                <td class="px-4 py-3">
                                    <div class="font-medium text-gray-800"><?php echo e($request->student->first_name ?? 'Unknown'); ?> <?php echo e($request->student->last_name ?? ''); ?></div>
                                    <div class="text-xs text-gray-500"><?php echo e($request->student->email ?? ''); ?></div>
                                </td>
                                <td class="px-4 py-3 font-mono text-gray-600"><?php echo e($request->student->student_id ?? 'N/A'); ?></td>
                                <td class="px-4 py-3 text-gray-600"><?php echo e($request->student->course ?? 'N/A'); ?></td>
                                <td class="px-4 py-3 text-gray-600"><?php echo e($request->student->year_level ?? 'N/A'); ?></td>
                                <td class="px-4 py-3 text-gray-500 text-xs"><?php echo e($request->submitted_at ? $request->submitted_at->format('M d, Y') : 'N/A'); ?></td>
                                <td class="px-4 py-3">
                                    <div class="flex gap-2">
                                        <form method="POST" action="<?php echo e(route('staff.approve', $request->id)); ?>" class="inline">
                                            <?php echo csrf_field(); ?>
                    ...
                    <table class="w-full text-sm">
                        ...
                        <tbody class="divide-y divide-gray-100">
                            ...
                            <tr class="hover:bg-gray-50 transition">
                                ...
                                <td class="px-4 py-3 text-gray-600"><?php echo e($request->student->course ?? 'N/A'); ?></td>
                                <td class="px-4 py-3 text-gray-600"><?php echo e($request->student->year_level ?? 'N/A'); ?></td>
                                <td class="px-4 py-3 text-gray-500 text-xs"><?php echo e($request->updated_at ? $request->updated_at->format('M d, Y h:i A') : 'N/A'); ?></td>
                                <td class="px-4 py-3">
        ...
        <div id="verified-tab" class="tab-content hidden">
            <?php if(($verifiedStudents ?? collect([]))->count() > 0): ?>
                <div class="mb-4 flex flex-wrap justify-between items-center gap-2">
                    ...
                    <span class="text-xs bg-blue-100 text-blue-700 px-3 py-1 rounded-full font-medium">
                        <i class="fas fa-users mr-1"></i> Total: <?php echo e($verifiedStudents->count()); ?>
                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-sm">
                        ...
                        <tbody class="divide-y divide-gray-100">
                            <?php $__currentLoopData = $verifiedStudents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="hover:bg-gray-50 transition">
                                <td class="px-4 py-3 text-gray-400 text-xs"><?php echo e($index + 1); ?></td>
                                <td class="px-4 py-3">
                                    <div class="font-medium text-gray-800"><?php echo e($student->first_name ?? ''); ?> <?php echo e($student->last_name ?? ''); ?></div>
                                </td>
                                <td class="px-4 py-3 font-mono text-gray-600"><?php echo e($student->student_id ?? 'N/A'); ?></td>
                                <td class="px-4 py-3 text-gray-600"><?php echo e($student->course ?? 'N/A'); ?></td>
                                <td class="px-4 py-3 text-gray-600"><?php echo e($student->year_level ?? 'N/A'); ?></td>
                                <td class="px-4 py-3">
                    ...
                    <table class="w-full text-sm">
                        ...
                        <tbody class="divide-y divide-gray-100">
                            ...
                            <tr class="hover:bg-gray-50 transition">
                                ...
                                <td class="px-4 py-3 font-mono text-gray-600"><?php echo e($request->student->student_id ?? 'N/A'); ?></td>
                                <td class="px-4 py-3 text-gray-600"><?php echo e($request->student->course ?? 'N/A'); ?></td>
                                <td class="px-4 py-3 text-gray-500 text-xs"><?php echo e($request->updated_at ? $request->updated_at->format('M d, Y') : 'N/A'); ?></td>
                                <td class="px-4 py-3 text-xs text-red-600"><?php echo e($request->remarks ?? 'No remarks'); ?></td>
                            </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </tbody>
                    </table>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.staff', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/vol15_6/infinityfree.com/if0_42013478/voidclearancesystem.gt.tc/htdocs/resources/views/staff/test-dashboard.blade.php ENDPATH**/ ?>