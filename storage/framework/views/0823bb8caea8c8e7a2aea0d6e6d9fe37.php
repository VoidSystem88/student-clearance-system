    ...
    <div class="bg-white rounded shadow overflow-x-auto">
        <table class="w-full">
            ...
            <tbody id="studentsTableBody">
                ...
                <tr class="border-b hover:bg-gray-50 student-row" data-name="<?php echo e(strtolower($student->first_name . ' ' . $student->last_name)); ?>" 
                    data-student-id="<?php echo e($student->student_id); ?>" data-email="<?php echo e(strtolower($student->email)); ?>" data-course="<?php echo e($student->course); ?>">
                    <td class="p-3"><?php echo e($student->id); ?></td>
                    <td class="p-3 font-mono text-sm"><?php echo e($student->student_id); ?></td>
                    <td class="p-3 font-mono text-sm"><?php echo e($student->account_id ?? 'N/A'); ?></td>
                    <td class="p-3 font-semibold"><?php echo e($student->first_name); ?> <?php echo e($student->last_name); ?></td>
                    <td class="p-3"><?php echo e($student->email); ?></td>
                    <td class="p-3"><?php echo e($student->course); ?></td>
                    <td class="p-3"><?php echo e($student->year_level ?? 'N/A'); ?></td>
                    <td class="p-3">
                    ...
                    <td class="p-3">
                        <div class="flex gap-2 flex-wrap">
                            <button onclick="openEditModal(<?php echo e($student->id); ?>)" class="bg-yellow-500 text-white px-3 py-1 rounded text-sm hover:bg-yellow-600 transition">
                                <i class="fas fa-edit"></i> Edit
                            </button>
                            <button onclick="confirmArchive(<?php echo e($student->id); ?>, '<?php echo e(addslashes($student->first_name . ' ' . $student->last_name)); ?>')" 
                                    class="bg-red-600 text-white px-3 py-1 rounded text-sm hover:bg-red-700 transition">
                                <i class="fas fa-archive"></i> Archive
                            </button>
                            <button onclick="confirmDelete(<?php echo e($student->id); ?>, '<?php echo e(addslashes($student->first_name . ' ' . $student->last_name)); ?>')" 
                                    class="bg-purple-600 text-white px-3 py-1 rounded text-sm hover:bg-purple-700 transition">
                                <i class="fas fa-trash-alt"></i> Delete
                            </button>
                        </div>
                        <form id="archive-form-<?php echo e($student->id); ?>" method="POST" action="<?php echo e(route('admin.student.archive', $student->id)); ?>" class="hidden">
                            <?php echo csrf_field(); ?>
                        </form>
                        <form id="delete-form-<?php echo e($student->id); ?>" method="POST" action="<?php echo e(route('admin.student.destroy', $student->id)); ?>" class="hidden">
                            <?php echo csrf_field(); ?>
...
<script>
    ...
    function openAddModal() {
        ...
        document.getElementById('studentForm').action = '<?php echo e(route("admin.student.store")); ?>';
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/vol15_6/infinityfree.com/if0_42013478/voidclearancesystem.gt.tc/htdocs/resources/views/admin/students.blade.php ENDPATH**/ ?>