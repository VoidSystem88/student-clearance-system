...
<?php $__env->startSection('header', 'Clearance Management'); ?>
    ...
    <div class="stat-card rounded-xl p-4 shadow-sm border">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="stat-value-blue text-2xl font-bold"><?php echo e($totalStudents ?? 0); ?></p>
            </div>
    ...
    <div class="stat-card rounded-xl p-4 shadow-sm border">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="stat-value-yellow text-2xl font-bold"><?php echo e($pendingCount ?? 0); ?></p>
            </div>
    ...
    <div class="stat-card rounded-xl p-4 shadow-sm border">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="stat-value-green text-2xl font-bold"><?php echo e($approvedCount ?? 0); ?></p>
            </div>
    ...
    <div class="stat-card rounded-xl p-4 shadow-sm border">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="stat-value-red text-2xl font-bold"><?php echo e($rejectedCount ?? 0); ?></p>
            </div>
    ...
    <div class="stat-card rounded-xl p-4 shadow-sm border">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="stat-value-purple text-2xl font-bold"><?php echo e($exportsCount ?? 0); ?></p>
            </div>
    ...
    <div class="border-b" style="border-color: var(--border-color);">
        <nav class="flex gap-2 flex-wrap" aria-label="Tabs">
            <button onclick="switchTab('queue')" id="tabQueueBtn" class="tab-btn active px-5 py-2.5 text-sm font-medium rounded-t-lg bg-blue-600 text-white transition">
                <i class="fas fa-clock mr-2"></i> Queue <span class="ml-1">(<?php echo e($pendingCount ?? 0); ?>)</span>
            </button>
            <button onclick="switchTab('approved')" id="tabApprovedBtn" class="tab-btn px-5 py-2.5 text-sm font-medium rounded-t-lg bg-gray-200 text-gray-700 hover:bg-gray-300 transition">
                <i class="fas fa-check-circle mr-2"></i> Approved <span class="ml-1">(<?php echo e($approvedCount ?? 0); ?>)</span>
            </button>
            <button onclick="switchTab('rejected')" id="tabRejectedBtn" class="tab-btn px-5 py-2.5 text-sm font-medium rounded-t-lg bg-gray-200 text-gray-700 hover:bg-gray-300 transition">
                <i class="fas fa-times-circle mr-2"></i> Rejected <span class="ml-1">(<?php echo e($rejectedCount ?? 0); ?>)</span>
            </button>
            ...
            <button onclick="switchTab('reports')" id="tabReportsBtn" class="tab-btn px-5 py-2.5 text-sm font-medium rounded-t-lg bg-gray-200 text-gray-700 hover:bg-gray-300 transition">
                <i class="fas fa-chart-line mr-2"></i> Reports <span class="ml-1">(<?php echo e($exportsCount ?? 0); ?>)</span>
            </button>
            <button onclick="switchTab('verified')" id="tabVerifiedBtn" class="tab-btn px-5 py-2.5 text-sm font-medium rounded-t-lg bg-gray-200 text-gray-700 hover:bg-gray-300 transition">
                <i class="fas fa-check-double mr-2"></i> Verified List <span class="ml-1">(<?php echo e($verifiedCount ?? 0); ?>)</span>
            </button>
        </nav>
    </div>
</div>
            ...
            <table class="w-full data-table">
                ...
                <tbody>
                    ...
                    <tr class="hover:bg-gray-50 transition">
                        <td class="px-5 py-3 font-mono text-sm"><?php echo e($request->student->student_id ?? 'N/A'); ?></td>
                        <td class="px-5 py-3">
                            <div class="font-medium"><?php echo e($request->student->first_name ?? ''); ?> <?php echo e($request->student->last_name ?? ''); ?></div>
                            <div class="text-xs" style="color: var(--text-secondary);"><?php echo e($request->student->email ?? ''); ?></div>
                        </td>
                        <td class="px-5 py-3">
                            <span class="inline-flex items-center px-2 py-1 rounded text-xs font-medium
                                <?php if($request->student->year_level == '1st Year'): ?> badge-blue
                                <?php elseif($request->student->year_level == '2nd Year'): ?> badge-green
                                <?php elseif($request->student->year_level == '3rd Year'): ?> badge-yellow
                                <?php else: ?> badge-purple <?php endif; ?>">
                                <i class="fas fa-graduation-cap mr-1 text-xs"></i>
                                <?php echo e($request->student->year_level ?? 'N/A'); ?>

                            </span>
                        </td>
                        <td class="px-5 py-3 text-sm"><?php echo e($request->submitted_at ? $request->submitted_at->format('M d, Y') : 'N/A'); ?></td>
                        <td class="px-5 py-3">
                            <button onclick="openApproveModal(<?php echo e($request->id); ?>)" class="bg-green-600 hover:bg-green-700 text-white px-3 py-1 rounded text-sm transition">
                                <i class="fas fa-check mr-1"></i> Approve
                            </button>
                            <button onclick="openRejectModal(<?php echo e($request->id); ?>)" class="bg-red-600 hover:bg-red-700 text-white px-3 py-1 rounded text-sm transition ml-2">
    ...
    <div class="data-table rounded-xl shadow-sm border overflow-hidden">
        ...
        <div class="overflow-x-auto">
            <table class="w-full data-table">
                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $approvedRequests ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $request): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr class="hover:bg-gray-50 transition">
                        <td class="px-5 py-3 font-mono text-sm"><?php echo e($request->student->student_id ?? 'N/A'); ?></td>
                        <td class="px-5 py-3">
                            <div class="font-medium"><?php echo e($request->student->first_name ?? ''); ?> <?php echo e($request->student->last_name ?? ''); ?></div>
                        ...
                        <td class="px-5 py-3 text-sm"><?php echo e($request->processed_at ? $request->processed_at->format('M d, Y') : 'N/A'); ?></td>
                    </tr>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                    <tr>
    ...
    <div class="data-table rounded-xl shadow-sm border overflow-hidden">
        ...
        <div class="overflow-x-auto">
            <table class="w-full data-table">
                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $rejectedRequests ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $request): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr class="hover:bg-gray-50 transition">
                        <td class="px-5 py-3 font-mono text-sm"><?php echo e($request->student->student_id ?? 'N/A'); ?></td>
                        <td class="px-5 py-3">
                            <div class="font-medium"><?php echo e($request->student->first_name ?? ''); ?> <?php echo e($request->student->last_name ?? ''); ?></div>
                        ...
                        <td class="px-5 py-3 text-sm" style="color: var(--danger-text);"><?php echo e($request->remarks ?? 'No reason'); ?></td>
                    </tr>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                    <tr>
                        <td colspan="4" class="px-5 py-8 text-center" style="color: var(--text-secondary);">
            ...
            <div class="flex justify-between items-center flex-wrap gap-3">
                ...
                <div class="flex gap-2">
                    <select id="yearLevelFilter" class="border rounded-lg px-3 py-1 text-sm" style="background-color: var(--input-bg); border-color: var(--input-border); color: var(--text-primary);" onchange="filterRequirements()">
                        ...
                        <?php $assignedYears = $department->getAssignedYearLevels(); ?>
                        <?php $__currentLoopData = $assignedYears; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $year): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($year); ?>"><i class="fas fa-graduation-cap"></i> <?php echo e($year); ?></option>
        ...
        <div class="overflow-x-auto">
            <table class="w-full data-table">
                ...
                <tbody id="requirementsTableBody">
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $allRequirements; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $req): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr class="hover:bg-gray-50 transition requirement-row" data-year="<?php echo e($req->year_level); ?>">
                        <td class="px-5 py-3">
                            <span class="inline-flex items-center px-2 py-1 rounded text-xs font-medium
                                <?php if($req->year_level == '1st Year'): ?> badge-blue
                                <?php elseif($req->year_level == '2nd Year'): ?> badge-green
                                <?php elseif($req->year_level == '3rd Year'): ?> badge-yellow
                                <?php else: ?> badge-purple <?php endif; ?>">
                                <i class="fas fa-graduation-cap mr-1 text-xs"></i>
                                <?php echo e($req->year_level); ?>

                            </span>
                        </td>
                        <td class="px-5 py-3"><?php echo e($req->requirement_name); ?></td>
                        <td class="px-5 py-3">
                        ...
                        <td class="px-5 py-3">
                            <button onclick="editRequirement(<?php echo e($req->id); ?>, '<?php echo e(addslashes($req->requirement_name)); ?>', <?php echo e($req->is_required ? 'true' : 'false'); ?>, <?php echo e($req->is_active ? 'true' : 'false'); ?>, '<?php echo e($req->year_level); ?>')" 
                                    class="bg-yellow-600 hover:bg-yellow-700 text-white px-3 py-1 rounded text-sm transition">
                                <i class="fas fa-edit"></i> Edit
                            </button>
                            <button onclick="deleteRequirement(<?php echo e($req->id); ?>, '<?php echo e(addslashes($req->requirement_name)); ?>')" 
...
<div id="reportsTab" class="tab-pane hidden">
    <div class="data-table rounded-xl shadow-sm border overflow-hidden">
        ...
        <div class="overflow-x-auto">
            <?php if(isset($exports) && $exports->count() > 0): ?>
            <table class="w-full data-table">
                <thead>
                    <tr>
                ...
                <tbody>
                    ...
                    <tr class="hover:bg-gray-50 transition">
                        <td class="px-5 py-3"><?php echo e($export->event_name); ?></td>
                        <td class="px-5 py-3"><?php echo e($export->total_records); ?></td>
                        <td class="px-5 py-3 text-sm"><?php echo e(\Carbon\Carbon::parse($export->export_date)->format('M d, Y')); ?></td>
                        <td class="px-5 py-3">
                            <button onclick="downloadReport(<?php echo e($export->id); ?>)" class="bg-blue-600 hover:bg-blue-700 text-white px-3 py-1 rounded text-sm transition">
                                <i class="fas fa-download"></i> Download
                            </button>
                            <button onclick="importReport(<?php echo e($export->id); ?>)" class="bg-green-600 hover:bg-green-700 text-white px-3 py-1 rounded text-sm transition ml-2">
        ...
        <div class="overflow-x-auto">
            <table class="w-full data-table">
                ...
                <tbody id="verifiedTableBody">
                    <?php $__empty_1 = true; $__currentLoopData = $verifiedStudents ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $verified): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr class="hover:bg-gray-50 transition verified-row" data-year="<?php echo e($verified['year_level'] ?? 'N/A'); ?>">
                        <td class="px-5 py-3 font-mono text-sm"><?php echo e($verified['student_id'] ?? 'N/A'); ?></td>
                        <td class="px-5 py-3"><?php echo e($verified['student_name'] ?? 'N/A'); ?></td>
                        <td class="px-5 py-3"><?php echo e($verified['course'] ?? 'N/A'); ?></td>
                        <td class="px-5 py-3">
                            <span class="inline-flex items-center px-2 py-1 rounded text-xs font-medium
                                <?php if(($verified['year_level'] ?? '') == '1st Year'): ?> badge-blue
                                <?php elseif(($verified['year_level'] ?? '') == '2nd Year'): ?> badge-green
                                <?php elseif(($verified['year_level'] ?? '') == '3rd Year'): ?> badge-yellow
                                <?php else: ?> badge-purple <?php endif; ?>">
                                <i class="fas fa-graduation-cap mr-1 text-xs"></i>
                                <?php echo e($verified['year_level'] ?? 'N/A'); ?>
...
<div id="addRequirementModal" class="fixed inset-0 bg-black bg-opacity-50 hidden items-center justify-center z-50 p-4">
    <div class="modal-content rounded-xl p-6 w-full max-w-md">
        ...
        <form id="addRequirementForm" method="POST" action="<?php echo e(route('staff.year-requirements.store')); ?>">
            <?php echo csrf_field(); ?>
            <div class="mb-4">
...
<div id="uploadCSVModal" class="fixed inset-0 bg-black bg-opacity-50 hidden items-center justify-center z-50 p-4">
    <div class="modal-content rounded-xl p-6 w-full max-w-md">
        ...
        <form id="uploadCSVForm" method="POST" action="<?php echo e(route('staff.verified.upload-csv')); ?>" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            <div class="mb-4">
