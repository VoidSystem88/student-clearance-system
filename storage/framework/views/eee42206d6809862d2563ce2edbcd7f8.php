...
<?php $__env->startSection('header', 'Database Backup'); ?>
...
<div class="container mx-auto">
    ...
    <div class="bg-white rounded-lg shadow-md p-6 mb-6">
        ...
        <form method="POST" action="<?php echo e(route('admin.backup.import')); ?>" enctype="multipart/form-data" class="mt-4" onsubmit="return confirm('WARNING: Importing will overwrite existing data. Continue?')">
            <?php echo csrf_field(); ?>
                ...
                <table class="w-full">
                    ...
                    <tbody>
                        ...
                        <tr class="border-b hover:bg-gray-50">
                            ...
                            <td class="p-3"><?php echo e($backup['size'] ?? 'Unknown'); ?></td>
                            <td class="p-3">
                                <?php
                            ...
                            <td class="p-3">
                                <div class="flex gap-2">
                                    <a href="<?php echo e(route('admin.backup.download', ['filename' => $backup['name']])); ?>" 
                                       class="bg-green-600 text-white px-3 py-1 rounded text-sm hover:bg-green-700 transition flex items-center gap-1">
                                        <i class="fas fa-download"></i> Download
                                    </a>
                                    <form method="POST" action="<?php echo e(route('admin.backup.delete', ['filename' => $backup['name']])); ?>" 
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/vol15_6/infinityfree.com/if0_42013478/voidclearancesystem.gt.tc/htdocs/resources/views/admin/backup.blade.php ENDPATH**/ ?>