        ...
        <table class="w-full">
            ...
            <tbody>
                ...
                <tr class="border-b hover:bg-gray-50 transition">
                    <td class="p-3 text-sm"><?php echo e($reminder->id); ?></td>
                    <td class="p-3 font-semibold text-gray-800"><?php echo e($reminder->title); ?></td>
                    <td class="p-3">
                    ...
                    <td class="p-3 text-sm"><?php echo e($reminder->department->name ?? 'All'); ?></td>
                    <td class="p-3 text-sm">
                        <?php echo e($reminder->start_date ? \Carbon\Carbon::parse($reminder->start_date)->format('M d, Y') : 'Always'); ?>

                        -
                        <?php echo e($reminder->end_date ? \Carbon\Carbon::parse($reminder->end_date)->format('M d, Y') : 'Always'); ?>
                    ...
                    <td class="p-3">
                        <div class="flex gap-1">
                            <button onclick="openEditModal(<?php echo e($reminder->id); ?>)" class="bg-yellow-500 text-white px-3 py-1 rounded text-sm hover:bg-yellow-600 transition">
                                <i class="fas fa-edit"></i> Edit
                            </button>
                            <button onclick="toggleReminder(<?php echo e($reminder->id); ?>, '<?php echo e(addslashes($reminder->title)); ?>', <?php echo e($reminder->is_active ? 'true' : 'false'); ?>)" 
                                    class="inline-flex items-center gap-1 <?php echo e($reminder->is_active ? 'bg-gray-500 hover:bg-gray-600' : 'bg-green-500 hover:bg-green-600'); ?> text-white px-3 py-1 rounded text-sm transition">
                                <i class="fas <?php echo e($reminder->is_active ? 'fa-ban' : 'fa-check'); ?>"></i>
                                <?php echo e($reminder->is_active ? 'Deactivate' : 'Activate'); ?>
                        ...
                        <form id="delete-form-<?php echo e($reminder->id); ?>" method="POST" action="<?php echo e(route('support.reminder.destroy', $reminder->id)); ?>" class="hidden">
                            <?php echo csrf_field(); ?>
...
<script>
    ...
    function openAddModal() {
        ...
        document.getElementById('reminderForm').action = '<?php echo e(route("support.reminder.store")); ?>';
...
<?php echo $__env->make('layouts.support', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/vol15_6/infinityfree.com/if0_42013478/voidclearancesystem.gt.tc/htdocs/resources/views/support/reminders.blade.php ENDPATH**/ ?>